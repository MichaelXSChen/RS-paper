...
parallel. Leveraging this protocol, \xxx presents a fast network output 
checking protocol to assure whether replicas run in sync.
...
consensus latency with a replica group size of three to seven; and (4) 
