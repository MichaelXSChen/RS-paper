...
\newcommand{\mytitle}[0]{\textbf {\paxos Made Much More Scalable with RDMA}}
...
\newcommand{\fasterDARElow}[0]{65.1\%\xspace} % TBD
\newcommand{\fasterDARE}[0]{4.4x\xspace} % TBD
\newcommand{\xxxlatencythree}[0]{8.8 \us\xspace} % TBD
\newcommand{\xxxlatencyonezerofive}[0]{31.1 \us\xspace} % TBD

\newcommand{\comptradlow}[0]{11.1x\xspace} % TBD
\newcommand{\comptradhigh}[0]{22.2x\xspace} % TBD

\newcommand{\tradlatencyincreaselow}[0]{33.3\%\xspace} % TBD
\newcommand{\tradlatencyincreasehigh}[0]{77.7\%\xspace} % TBD
\newcommand{\systemcostlow}[0]{44.4\%\xspace} % TBD
\newcommand{\systemcosthigh}[0]{88.8\%\xspace} % TBD
\newcommand{\xxxscalability}[0]{3.89x\xspace} % TBD
\newcommand{\darescalability}[0]{21.12x\xspace} % TBD
