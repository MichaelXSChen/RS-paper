...
\newcommand{\mytitle}[0]{\textbf {\xxx: Fast and Scalable \paxos
on RDMA}}
...
\newcommand{\redis}[0]{\v{Redis}\xspace}
...
\newcommand{\github}[0]{\url{http://github.com/icdcs17-p256/apus}}
\newcommand{\latencyfig}[0]{\url{http://github.com/icdcs17-p256/extra-figures/la
tency-overhead.pdf} }
...
\newcommand{\fasterDARElow}[0]{87.9\%\xspace}%TBD
\newcommand{\fasterDAREhigh}[0]{763.4\%\xspace}%TBD
\newcommand{\fasterDAREconsensusonly}[0]{53.2\%\xspace}%TBD
% DARE avg: 43.82
% APUS avg: 9.2
...
\newcommand{\comptradhigh}[0]{158.6x\xspace} % TBD

\newcommand{\tradlatencyincreaselow}[0]{105.4\%\xspace} % TBD
\newcommand{\tradlatencyincreasehigh}[0]{168.3\%\xspace} % TBD
...
\author{Cheng Wang, Jianyu Jiang, Xusheng Chen, Ning Yi, and Heming Cui}
% \author[*]{Heming Cui}
...
\affil{\textrm Department of Computer Science, University of Hong Kong}
