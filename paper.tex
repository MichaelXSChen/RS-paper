...
\newcommand{\mytitle}[0]{\textbf {\xxx: A Speedy, General State Machine 
Replication System}}
...
% Evaluation stats.
\newcommand{\github}[0]{\url{github.com/usec16-paper4/owl}}
% \newcommand{\ntype}[0]{four\xspace}
\newcommand{\nprog}[0]{11\xspace}
\newcommand{\nattacks}[0]{27\xspace}
\newcommand{\nconfirmed}[0]{15\xspace}
\newcommand{\nreproduced}[0]{11\xspace} % Concurrency attacks that we reproduced
\newcommand{\nreproducedProgs}[0]{7\xspace}
\newcommand{\nreproducedNoRetry}[0]{8\xspace}
\newcommand{\nreproducedInter}[0]{7\xspace}
\newcommand{\napacheDetected}[0]{783\xspace} % race report number of apache
\newcommand{\nmysqlDetected}[0]{530\xspace} % race report number of mysql
