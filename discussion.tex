...
(\S\ref{sec:eval-dare}), \dare mentioned that their design points 
do not include scalability. Third, although \xxx's protocol includes a 
persistent storage to ensure durability, \xxx was faster than 
\dare by about \fasterDARE. \S\ref{sec:eval-dare} analyzes \xxx and \dare 
performance.
