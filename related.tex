...
FPGA. These systems are suitable to maintain compact metadata. However, 
as mentioned in prior work~\cite{nopaxos:osdi16}, these systems' programmable 
hardware are not suitable to store large amount of replicated states (\eg, 
server programs' continuously arriving inputs).
