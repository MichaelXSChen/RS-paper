...
distributed systems~\cite{spanner:osdi12,mencius:osdi08}, much study 
have been done to improve specific aspects of consensus, 
...
rules~\cite{modist:nsdi09,demeter:sosp11}. \paxos is extended to tolerate 
byzantine faults~\cite{brun:icdcs12,meling:icdcs12,bal:icdcs12,pbft:osdi99,
zyzzyva:sosp07} and hardware faults~\cite{hardpaxos:srds14}.
