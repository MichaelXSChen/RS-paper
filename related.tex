...
suitable to maintain compact metadata. Prior work~\cite{nopaxos:osdi16} 
pointed out that these systems' programmable hardware are not suitable to store 
large amount of replicated states (\eg, server programs' continuously arriving 
inputs).
