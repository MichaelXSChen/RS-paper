...
these three systems evaluate their response time overhead on key-value stores 
which are sensitive on latency. \xxx is the first SMR system that achieves low 
overhead on both response time and throughput on real-world key-value stores.
