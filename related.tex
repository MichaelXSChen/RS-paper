...
deterministic and stable multithreading techniques have 
been developed~\cite{grace:oopsla09, dthreads:sosp11, 
determinator:osdi10,dpj:oopsla09, 
dmp:asplos09,kendo:asplos09,coredet:asplos10,dos:osdi10,ddos:asplos13,
ics:oopsla13}. Another way to mitigate nondeterminism and to ease debugging 
concurrency bugs is deterministic replay 
...
odr:sosp09, capo:asplos09}. Much of these techniques can greatly improve 
software reliability, but they often come with a performance slowdown. \xxx can 
run these techniques with the server program to mitigate replica divergence 
caused by concurrency bugs. 
