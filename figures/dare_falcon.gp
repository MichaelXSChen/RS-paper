...
# plot upper
#plot 'dare_falcon.dat' using 1:2 with linespoints title "DARE" ls 2, 'dare_falcon.dat' using 1:3 with linespoints title "Falcon" ls 3,'dare_falcon.dat' using 1:4 with linespoints title "DARE(90%Read)" ls 4
