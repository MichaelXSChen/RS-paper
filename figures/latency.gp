...
# plot A
set ylabel "latency (s)" offset 2,0
set key right top 
#set key at 0.1,0.1
#set key offset 3,3
#set key bmargin 30
...
set ytics 20
#set title "(a) Clamav"
set label 11 center at graph 0.5,-0.20 "(a) Clamav" font ",30"
...
# plot B
set ylabel "latency (us)" offset 2,0
...
set label 11 center at graph 0.5,-0.20 "(b) Mediatomb" font ",30"
...
set label 11 center at graph 0.5,-0.20 "(c) Memcached" font ",30"

plot 'latency.dat' using 1:6 with linespoints title "Unreplicated" ls 1,'latency.dat' using 1:7 with linespoints title "Falcon" ls 2
#plot sin(x) ls 3
unset yrange
unset ytics
...
set size 1.0,0.85
#set title "(d) Mongodb"
set label 11 center at graph 0.5,-0.20 "(d) Mongodb" font ",30"
...
set size 1.0,0.85
#set title "(e) Mysql"
set label 11 center at graph 0.5,-0.20 "(e) Mysql" font ",30"
...
set label 11 center at graph 0.5,-0.20 "(f) Openldap" font ",30"
...
set size 1.0,0.85
#set title "(g) Redis"
set label 11 center at graph 0.5,-0.20 "(g) Redis" font ",30"

plot 'latency.dat' using 1:14 with linespoints title "Unreplicated" ls 1,'latency.dat' using 1:15 with linespoints title "Falcon" ls 2
#plot sin(x) ls 7
unset yrange
unset ytics
...
set size 1.0,0.85
#set title "(h) Ssdb"
set label 11 center at graph 0.5,-0.20 "(h) Ssdb" font ",30"
...
set label 11 center at graph 0.5,-0.20 "(i) Calvin" font ",30"

plot 'latency.dat' using 1:18 with linespoints title "Unreplicated" ls 1,'latency.dat' using 1:19 with linespoints title "Falcon" ls 2
#plot sin(x) ls 9
unset yrange
unset ytics
