...
For each protocol, we spawned up to 24 concurrent connections for each client 
on one dedicated machine, and we used up to nine replicas. Both these two 
values are common and 
