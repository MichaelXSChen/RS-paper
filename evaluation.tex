...
& {\bf Systems}\\
\hline\\[-2.3ex]
\libpaxos-3 & 123.x  & 42.x & 11.x & 57.x\\
\libpaxos-9 & 123.x  & 42.x & 11.x & 57.x\\

\hline\\[-2.3ex]
\zookeeper-3 & 123.x  & 42.x & 11.x & 57.x\\
\zookeeper-9 & 123.x  & 42.x & 11.x & 57.x\\

\hline\\[-2.3ex]
\crane-3 & 123.x  & 42.x & 11.x & 57.x\\
\crane-9 & 123.x  & 42.x & 11.x & 57.x\\

\hline\\[-2.3ex]
\spaxos-3 & 123.x  & 42.x & 11.x & 57.x\\
\spaxos-9 & 123.x  & 42.x & 11.x & 57.x\\
...
latency of its majority ACK; ``Process" means the time spent in 
processing majority ACKs; and ``Systems" means the time spent in OS kernel, 
networking libraries, and JVM. All times are in \us.} 
