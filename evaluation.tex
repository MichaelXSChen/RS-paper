...
\xxx input consensus took only 9.1 \us (\redis) to 22.4 \us (\mediatomb). This 
consensus latency mainly depends on the ``Input" column: the average number of 
data bytes received in socket calls (\eg, \mongodb has the largest received 
...
reach consensus rapidly. This indicates \paxos's fault-tolerance strength: a 
