...
\item[\S\ref{sec:eval-traditional}:] How does \xxx compare
...
high~\cite{zookeeper,crane:sosp15,rex:eurosys14,dare:hpdc15}.
% Our evaluation also 
...
read-only optimization~\cite{eve:osdi12}. As space is limited, the response 
