...
\dare on seven replicas with randomly arriving, update-heavy (50\% SETs and 
...
reach consensus). \dare's evaluation~\cite{dare:hpdc15} also confirmed a high 
wait duration: with three replicas and nine concurrent clients, \dare's 
throughput on real-world inspred workloads (50\% SET and 50\% GET arriving 
randomly) was about 43.5\% lower than that on 100\% SET workloads.

Overall, these results suggest that \dare is better on smaller number of 
