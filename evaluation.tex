...
Table~\cite{tab:consensus-latency}). We plan to buy more RDMA servers and 
verify that whether \xxx's scalability is bounded by the capacity of the 
max number of outbound WRITEs in RDMA NIC hardware.
