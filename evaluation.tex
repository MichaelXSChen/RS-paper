...
programs' checkpoint timecost. Each periodic program checkpoint operation 
...
approach (\S\ref{sec:election}), shown in Figure~\ref{tab:election}. Because 
\paxos leader election is rarely invoked in practice, although this election
latency was slightly higher than its normal case consensus latency, we 
