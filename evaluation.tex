...
\end{tabular}
\vspace{-.05in}
\caption{{\em Performance breakdown of traditional consensus protocols 
...
clients, varied the number of replicas from three to seven. We found that \xxx 
consensus latency increased merely by 8.6\% and \dare increased by 
...
Each performance data point was taken from a mean value of 10 executions.
