...
For each protocol, we ran a client with 24 concurrent connections one dedicated 
machine, and we used up to nine replicas. Both these two values are common and 
high in relevant 
evluation~\cite{zookeeper,crane:sosp15,rex:eurosys14,dare:hpdc15}.
% Our evaluation also 
