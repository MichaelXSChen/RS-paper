...
except \spaxos. \spaxos batch requests from replicas and it only invokes 
...
more nodes. Afterall, its consensus latency was always over 600 \us. \xxx's 
...
they were done on only one backup, and the leader and other backups still form 
majority and reach consensus rapidly.
