...
slower than \xxx on large replica groups. Overall, given that \xxx has a 
durable input storage, and \dare is a volatile protocol, we considered \xxx 
faster than \dare, espeically on large replica groups.
