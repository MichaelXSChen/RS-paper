...
empty, it took 0.039$\sim$0.12 \us; when the CQ has one or more ACKs randomly 
arrived from other replicas, it took 0.051$\sim$0.42 \us. As the number of ACKs 
is linear to replica group size, polling ACKs is a major scalability 
