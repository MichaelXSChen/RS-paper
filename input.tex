...
parallel (see \textbf{L3} in Figure~\ref{fig:logentry}). In implementation, 
\xxx uses selective signaling (\S\ref{sec:background}) to occasionally clear 
ACKs in the CQ associated with the QP.
