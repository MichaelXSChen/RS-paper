...
parallel (see \textbf{L3} in Figure~\ref{fig:logentry}). In a implementation 
level, \xxx uses selective signaling (\S\ref{sec:background}) to occasionally 
check and clear ACKs in the CQ associated with the QP.
