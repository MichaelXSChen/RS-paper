...
Unfortunately, despite these advances, \paxos's high consensus latency makes
...
latency could be acceptable for leader election~\cite{chubby:osdi,zookeeper} or
