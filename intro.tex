...
replication models are proposed, including multi-leader (or nonleader) 
...
to send an ACK to the local host's NIC. An evaluation~\cite{pilaf:atc14} shows 
that such a write round-trip takes only $\sim$3 \us in the Infiniband 
...
across replicas. In a consensus protocol level, \xxx carefully tacklles several 
