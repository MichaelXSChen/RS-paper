...
improve both the scale and performance of many existing replication 
...
Overall, a fast, scalable, and general service, \xxx may largely promote the 
deployments of \paxos and improve both the consistency and 
