...
multithreading~\cite{zookeeper, spaxos:srds12} or asynchrous 
...
leadership~\cite{mencius:osdi08,spaxos:srds12}, and hieratical 
replication~\cite{manos:hotdep10,scatter:sosp11}. These systems have
improved systems throughtput, however, the core of these systems, \paxos, still
faces an unscable 
consensus latency~\cite{ellis:thesis,scatter:sosp11,manos:hotdep10}.
...
% Memory semantic.
Fortunately, Remote Direct Access Memory (RDMA) becomes a possible scalability 
...
directly on desination replicas' memory, and let all replicas poll their 
...
manos:hotdep10,scatter:sosp11} can scale even better with \xxx. Overall, a 
scalable and general service, \xxx may largely promote \paxos deployments and 
