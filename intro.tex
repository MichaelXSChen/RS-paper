...
% P10: Contribution. Applications: other replications, parallel program 
% analysis, and datacenter OS (it's efficiency and strong consistency makes 
% system calls go beyond single machine).
