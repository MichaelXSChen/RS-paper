...
Our major conceptual contribution is to explore a new design point: 
leveraging RDMA to build a fast, general \paxos 
consensus protocol. This new protocol incorporates fasted RDMA hardware 
features, while it still pertains same fault-tolerance guarantees as 
