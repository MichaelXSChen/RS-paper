...
improved systems throughput, however, the core of these systems, \paxos, still
faces an unsalable 
...
However, due to the unrich types of RDMA primitives, fully exploiting RDMA
...
ran with 20 concurrent proposing clients.}
