...
consensus latency outperforms four traditional \paxos protocols by up
to \comptradhigh. \xxx's consensus latency stays almost constant to the number 
of concurrent requests and replicas. \xxx's consensus latency was faster than 
...
six protocols ran 24 concurrent proposing clients. Both X and Y axes are broken 
to fit 
