...
serving concurent client requests. Second, some advanced SMR systems (\eg, 
...
with 24 CPU cores and 40Gbps network, then we spawned 24 cocurrent consensus 
...
evaluation (\S\ref{sec:eval-dare}) confirmed that, as the number of concurrent 
requests increased, \dare's consensus latency increased almost linearly.
