...
(typically, \paxos~\cite{paxos:practical,paxos}). 
Recent SMR 
...
computers with 40Gbps network, then we spawned 24 concurrent consensus 
connections. When the number of replicas increased from three to nine, the 
